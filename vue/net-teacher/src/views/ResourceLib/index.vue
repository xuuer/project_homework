<template>
            ...
            <div class="item-container">
              ...
              <div class="opr">
                <el-tooltip content="下载" placement="bottom">
                  <el-button type="success" :icon="Download" circle @click.stop="download(res)"/>
                </el-tooltip>
  ...
  <!-- 添加资源的弹出框 -->
  <el-dialog v-model="dialogVisible" :title="id ? '修改资源信息' : '上传资源'" :before-close="handleBeforeClose" style="min-width: 400px;">
